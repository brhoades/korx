...
#define EVOS(X) text "Evos: " text X
...

{
  name ammopackitem
  text "Ammo Pack\n\n"
  text "Back-mounted ammo pack that permits storage of extra clips "
  text "for non-energy weapons.\n\n"
  CREDITS( AMMOPACK_PRICE )
}

{
  name surgeitem
  text "Surge\n\n"
  text "A clip extension that can be only used for lasgun and massdriver. "
  text "It doubles the ammo usage and damage.\n\n"
  CREDITS( SURGE_PRICE )
}
