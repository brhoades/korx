...
static cvarTable_t cvarTable[ ] =
{
  ...
  { &cg_teamOverlayUserinfo, "teamoverlay", "1", /*CVAR_ROM |*/ CVAR_USERINFO|CVAR_ARCHIVE },
...
//  { &cl_gender, "cl_gender", "male", CVAR_ARCHIVE },
...
static void CG_RegisterSounds( void )
{
  ...
  cgs.media.lCannonWarningSound2    = trap_S_RegisterSound( "sound/weapons/lcannon/warning2.wav", qfalse );
}
...
static void CG_RegisterGraphics( void )
{
  ...
  cgs.media.invisShader               = trap_R_RegisterShader("gfx/invis" );
  cgs.media.invisFadeShader           = trap_R_RegisterShader("gfx/invisfade" );
  ...
  cgs.media.healthCross4X             = trap_R_RegisterShader( "ui/assets/neutral/cross4.tga" );
