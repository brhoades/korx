...
typedef struct
{
  ...
  timeWarning_t     countdownWarning5;
  timeWarning_t     countdownWarning4;
  timeWarning_t     countdownWarning3;
  timeWarning_t     countdownWarning2;
  timeWarning_t     countdownWarning1;
  timeWarning_t     goWarning;
...
gentity_t *fire_bounceBall( gentity_t *self, vec3_t start, vec3_t dir, int weapon, int dmg, int mod, int speed );
...
extern  vmCvar_t  g_doWebsiteSpam;
extern  vmCvar_t  g_websiteSpamMessage1;
extern  vmCvar_t  g_websiteSpamMessage2;
